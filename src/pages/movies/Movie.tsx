...
import SeasonCard from "../../components/posters/seasonPoster/SeasonPoster";
      ...
      <div className="container mt-96  md:my-2  mx-auto py-4">
        <div className="grid grid-cols-2 gap-4 mb-[30px] ">
          <div className="flex flex-row gap-4">
            ...
            <span className="cursor-pointer  hover:bg-[#D2D2D2] flex flex-row rounded-[10px] p-2 h-[40px]  bg-[#D9D9D9] text-black">
              1
            </span>
            <span className="cursor-pointer  hover:bg-[#D2D2D2] flex flex-row rounded-[10px] p-2 h-[40px] bg-[#D9D9D9] text-black">
              2
